...
function data_saving(InputParameters::InputParam,ResultsOpt::Results_3)
   ...
   @unpack (e_charge, e_discharge, rev, cap, soc, soc_quad, deg, deg_stage, gain_stage, cost_rev, x, y, z, h_x, h_y, h_z, w_xx, w_yy, w_zz, w_xy, w_xz, w_zy, h_x, h_y, h_z, h_xx, h_xy, h_xz, h_yy, h_zz, h_yz, e, rev_acquisto, rev_vendita) = ResultsOpt;
